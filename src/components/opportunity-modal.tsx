        ...
        {positions.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <Button 
              ...
              onClick={() => window.location.href = 'mailto:careers@kulisani.co.za?subject=Future Opportunities - Kulisani Capital'}
            >
              Submit Your CV
        ...
        <div className="pt-6 border-t border-gray-200">
          <div className="flex justify-between items-center">
            <p className="text-sm text-gray-600">
              ...
              <a href="mailto:careers@kulisani.co.za" className="text-brand-primary hover:underline ml-1">
                Contact our HR team
              </a>
            </p>
